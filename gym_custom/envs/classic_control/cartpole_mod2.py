"""
Copied from https://github.com/hardmaru/estool/blob/master/custom_envs/cartpole_swingup.py
- who copied from: https://github.com/zuoxingdong/DeepPILCO/blob/master/cartpole_swingup.py
...
A bit fancier rendering: cart has wheels.

USE 'cartpole_mod' INSTEAD
"""
...
class CartPoleSwingUp2Env(gym.Env):
    metadata = {
